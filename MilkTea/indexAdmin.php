<?php
  ...
  //Admin add product //
    ...
    // if(isset($_GET['edit'])){
    //   $name_edit = $GET['namePr'];
    //   $price_edit = $GET['pricePr'];
    //   $type_edit = $GET['typePr'];
    //   $image_edit = $GET['imgPr'];
    //   $stm = 'UPDATE milkteas SET namePr="'.$name_edit.'", pricePr='.$price_edit.', typePr="'.$type_edit.'", imagePr="image/'.$image_edit.'" WHERE id='.$_POST['edit'].'';
    //   $db->query($stm); 
    // }
...
<body>
  ...
  <div class="milk-container">
    ...
    <div class="item-milk">
      ...
      <form action="edit.php" method="get" class="btn">
