<?php
  ...
  require_once "Model/Juice_Tea.php";

  $sql = "SELECT * from MilkTeas WHERE type='Juice_Tea'";
...
<body>
  <div class="header">
    ...
    <form action="login.php" method="">
      <button style="background-color: green">Log in</button>
    </form>
    <form action="register.php" method="">
      <button style="margin-right: 30px; background-color:green">Register</button>
    </form>
  </div>

  <div class="image">
  	<img src="image/background.jpg" style="width: 70%; height: 400px; margin-top: 20px; margin-left: 200px;">
  </div>
